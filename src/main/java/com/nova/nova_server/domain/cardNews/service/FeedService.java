...
import com.nova.nova_server.domain.cardNews.dto.FeedResponse;
        ...
        return FeedListResponse.builder()
                ...
                .cardnews(
                        List.of(FeedResponse.builder()
                                ...
                                .author("nova team")
                                .publishedAt(LocalDateTime.of(2026, 2, 20, 0, 0))
                                ...
                                .siteName("Nova 블로그")
                                .keywords(List.of("SpringBoot", "React", "Next.js", "Java", "TypeScript", "AI"))
                                .saved(true)
                                .build())
                ).build();
    }
